...
export const V3_FACTORY_ADDRESS =
  process.env.NEXT_PUBLIC_V3_FACTORY_ADDRESS ?? '0x823AeB1D8ceD14F02a6a2e2080AC20E44D5d911D'
export const V3_POSITION_MANAGER_ADDRESS =
  process.env.NEXT_PUBLIC_V3_POSITION_MANAGER_ADDRESS ?? '0x245a9b3937b28cfAE315D9E498ae46A758652Ad1'
export const V3_SWAP_ROUTER_ADDRESS =
  process.env.NEXT_PUBLIC_V3_SWAP_ROUTER_ADDRESS ?? '0x8920e24184Ae7a1D55d64ef42f319139E9A72885'
...
export const V3_SWAP_ROUTER_ABI = [
  ...
  { inputs: [{ internalType: 'address', name: 'token', type: 'address' }, { internalType: 'uint256', name: 'amountMinimum', type: 'uint256' }, { internalType: 'address', name: 'recipient', type: 'address' }], name: 'sweepToken', outputs: [], stateMutability: 'payable', type: 'function' },
  { inputs: [{ internalType: 'uint256', name: 'amount0Delta', type: 'uint256' }, { internalType: 'uint256', name: 'amount1Delta', type: 'uint256' }, { internalType: 'bytes', name: '_data', type: 'bytes' }], name: 'uniswapV3SwapCallback', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [{ internalType: 'uint256', name: 'amountMinimum', type: 'uint256' }, { internalType: 'address', name: 'recipient', type: 'address' }], name: 'unwrapWETH9', outputs: [], stateMutability: 'payable', type: 'function' },
  { stateMutability: 'payable', type: 'receive' },
] as const
...
export const V3_POOL_ABI = [
  ...
  { anonymous: false, inputs: [{ indexed: false, internalType: 'uint8', name: 'feeProtocol0Old', type: 'uint8' }, { indexed: false, internalType: 'uint8', name: 'feeProtocol0New', type: 'uint8' }, { indexed: false, internalType: 'uint8', name: 'feeProtocol1Old', type: 'uint8' }, { indexed: false, internalType: 'uint8', name: 'feeProtocol1New', type: 'uint8' }], name: 'SetFeeProtocol', type: 'event' },
...
export const V3_FACTORY_DEPLOYMENT: DeploymentResult = {
  ...
  proxyAddress: null,
  implementationAddress: V3_FACTORY_ADDRESS,
  ...
  chainId: 8283,
  status: 'success',
  abi: V3_FACTORY_ABI as unknown as object[],
  createdAt: '',
  pinned: false,
  source: 'imported',
}
...
export const V3_POSITION_MANAGER_DEPLOYMENT: DeploymentResult = {
  ...
  proxyAddress: null,
  implementationAddress: V3_POSITION_MANAGER_ADDRESS,
  previousProxyAddress: null,
  txHash: null,
  blockNumber: null,
  deployer: null,
  ...
  chainId: 8283,
  status: 'success',
  abi: V3_POSITION_MANAGER_ABI as unknown as object[],
  createdAt: '',
  pinned: false,
  source: 'imported',
}
...
export const V3_SWAP_ROUTER_DEPLOYMENT: DeploymentResult = {
  ...
  type: 'SwapRouter',
  proxyAddress: null,
  implementationAddress: V3_SWAP_ROUTER_ADDRESS,
  previousProxyAddress: null,
  txHash: null,
  blockNumber: null,
  deployer: null,
  ...
  chainId: 8283,
  status: 'success',
  abi: V3_SWAP_ROUTER_ABI as unknown as object[],
  createdAt: '',
  pinned: false,
  source: 'imported',
}
