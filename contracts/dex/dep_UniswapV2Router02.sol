...
// Modified: pairFor uses Factory.getPair() instead of INIT_CODE_HASH
...
// --- UniswapV2Library (modified: uses Factory.getPair) ---
...
library UniswapV2Library {
    ...
    // Modified: uses Factory.getPair() instead of create2 address computation
...
contract UniswapV2Router02 {
    ...
    receive() external payable {
        assert(msg.sender == WKRC); // only accept ETH via fallback from the WKRC contract
    }
